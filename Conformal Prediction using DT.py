...
class DecisionTreeClassifier():
    def __init__(self, min_samples_split=2, max_depth=3,method='gini',leafs={},l=0,centroid_1=0,centroid_neg1=0):
...
def get_conformity_by_distance(X,Y,sample,model):
    ...
    for s in sample:
        p_val = []
        d1 = math.dist(centroid_1,s)
        d2 = math.dist(centroid_neg1,s)
        cs_1 = d2/d1
        cs_neg1 = d1/d2
...
#Increasing Noise
def IncreasingNoise():
    #Below lists will be used for CP with 1nd Conformity measure
    val_std = []
    val_ran = []
    acc_std = []
    acc_ran = []
...
import os   
result_std1.to_csv('result_std1.csv')
result_ran1.to_csv('result_ran1.csv')
result_std2.to_csv('result_std2.csv')
result_ran2.to_csv('result_ran2.csv')
